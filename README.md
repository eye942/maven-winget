...
```powershell
msiexec /i .\maven-community-<version>-x64.msi ALLUSERS=1 MSIINSTALLPERUSER=""
```

User MSI:

```powershell
msiexec /i .\maven-community-<version>-x64.msi ALLUSERS=2 MSIINSTALLPERUSER=1 /qn
```
...
```powershell
pwsh ./scripts/New-Release.ps1 -MavenVersion 3.9.16
```
