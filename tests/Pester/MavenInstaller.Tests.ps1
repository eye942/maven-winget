Describe 'Maven release helpers' {
 ...
 It 'parses Maven 3 stable versions' { (Get-MavenReleaseInfo '3.9.11').ArchiveName | Should -Be 'apache-maven-3.9.11-bin.zip' }
 It 'parses Maven 4 prereleases' { (Get-MsiVersion '4.0.0-rc-4') | Should -Be '4.0.0.1304' }
 It 'constructs official URLs' { (Get-MavenReleaseInfo '3.9.11').SourceUrl | Should -Match '^https://dlcdn.apache.org/maven/' }
 ...
 It 'formats paths with spaces' { Get-PathEntry 'C:\Program Files\Apache Maven\apache-maven-3.9.11' | Should -Be 'C:\Program Files\Apache Maven\apache-maven-3.9.11\bin' }
